...
// import { getIsActiveItem, checkIsExisted, updateMulti } from '../../common/utils/filter';
...
//   let rhApiUrl = _configs.rh.dataUrl + '/tbUngDungDVC' + getIsActiveItem(req);;
...
//   let checkIsEx = await checkIsExisted('tbUngDungDVC', 'Ma', req.body.Ma)
//   if (checkIsEx) {
...
//   let rhApiUrl = _configs.rh.dataUrl + '/tbUngDungDVC' + req.url;
...
//       //update multi 
//       await updateMulti('tbCauHinhKetNoi', { 'DichVuUngDung.code': body.code }, { 'DichVuUngDung': body })
//       //hết update multi
//       mwLog.generate(req, { status: rhApiRes.status, body: rhApiRes.data });
//       res.status(rhApiRes.status).send(rhApiRes.data);
//     }).catch(function (rhApiErr) {
//       console.log(rhApiErr)
//       try {
//         mwLog.generate(req, { status: rhApiErr.response.status, body: rhApiErr.response.data });
//         res.status(rhApiErr.response.status).send(rhApiErr.response.data);
//       } catch (e) {
