...
function getTable(req, res) {
  let rhApiUrl = _configs.rh.dataUrl + '/tbCauHinhKetNoi' + getIsActiveItem(req);
...
async function post(req, res) {
  ...
  let checkIsEx = await checkIsExisted('tbCauHinhKetNoi', 'Ma', req.body.Ma)
  if (checkIsEx) {
  ...
  let rhApiUrl = _configs.rh.dataUrl + '/tbCauHinhKetNoi' + req.url;
