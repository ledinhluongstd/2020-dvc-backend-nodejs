...
function getTable(req, res) {
  let rhApiUrl = _configs.rh.dataUrl + '/tbUngDung' + getIsActiveItem(req);;
...
async function post(req, res) {
  ...
  let checkIsEx = await checkIsExisted('tbUngDung', 'Ma', req.body.Ma)
  if (checkIsEx) {
  ...
  let rhApiUrl = _configs.rh.dataUrl + '/tbUngDung' + req.url;
