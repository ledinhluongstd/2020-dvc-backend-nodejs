...
function getTable(req, res) {
  let rhApiUrl = _configs.rh.dataUrl + '/tbCauHinhHeThong' + getIsActiveItem(req);;
...
async function post(req, res) {
  ...
  let checkIsEx = await checkIsExisted('tbCauHinhHeThong', 'Ma', req.body.Ma)
  if (checkIsEx) {
  ...
  let rhApiUrl = _configs.rh.dataUrl + '/tbCauHinhHeThong' + req.url;
